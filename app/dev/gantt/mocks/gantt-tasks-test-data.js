(function () {
    ...
    function getGanttTasksTestData() {
        var tasks = [
            ...
            { id: 6, name: "SMS 2A", start: "2016-05-22", end: "2016-05-22", parentID: 5, percentComplete: 100, isMilestone: true, order:1},
            { id: 9, name: "SubTask 2C", start: "2016-11-10", end: "2016-12-01", parentID: 5, percentComplete: 88, isMilestone: false, order:4},
            { id: 7, name: "SubTask 2A", start: "2016-05-22", end: "2016-06-29", parentID: 5, percentComplete: 33, isMilestone: false, order:2},
            { id: 8, name: "SubTask 2B", start: "2016-06-29", end: "2016-11-10", parentID: 5, percentComplete: 39, isMilestone: false, order:3},
            { id: 10, name: "SMS 2B", start: "2016-12-01", end: "2016-12-01", parentID: 5, percentComplete: 0, isMilestone: true, order:5},
