(function () {
    ...
    function getGanttTasksMock() {
        var tasks = [
            ...
            { id: 9, name: "SubTask C", start: "2016-11-10", end: "2016-12-01", parentID: 5, percentComplete: 88, isMilestone: false},
            { id: 10, name: "Sub Milestone B", start: "2016-12-01", end: "2016-12-01", parentID: 5, percentComplete: 0, isMilestone: true}
        ];
